#' marginal_effects.maxLik
#' @importFrom prediction find_data
#' @description import internal margins find_terms_in_model
#' @description import internal margins dydx
#' @export
marginal_effects.maxLik <-
  function(model,
    ...
    out1 <- lapply(c(varslist$nnames, varslist$lnames), margins:::dydx, data = data, model = model, type = type, eps = eps, as.data.frame = as.data.frame,  ...)
